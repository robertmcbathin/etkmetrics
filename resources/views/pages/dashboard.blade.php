        ...
        <div class="card-header">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu">
              ...
              <a class="dropdown-item text-danger" href="dashboard.html#">Remove Data</a>
            </div>
              </div>
        </div>
        <div class="card-body">
...
<th  class="text-right" >
    ...
    <td class="td-name">
        <a href="dashboard.html#jacket">Suede Biker Jacket</a>
    ...
    <td class="td-name">
        <a href="dashboard.html#pants">Jersey T-Shirt</a>
    ...
    <td class="td-name">
        <a href="dashboard.html#nothing">Slim-Fit Swim Short</a>
